# Generated by Powerlevel10k configuration wizard on 2021-08-01 at 14:52 CST.
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND=153  # original: 4
  # Default current directory foreground color.
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=236  # original: 254
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=1  # original: 250
  # Color of the anchor directory segments. Anchor segments are never shortened. The first
  # segment is always an anchor.
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=234  # original: 255
  ...
  typeset -g POWERLEVEL9K_VCS_CONFLICTED_BACKGROUND=1  # original: 3
  ...
  typeset -g POWERLEVEL9K_TRANSIENT_PROMPT=off  # original: always
