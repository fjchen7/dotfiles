...
export _git_completition_command=  # global variable to record command for _fzf_complete_git_post
...
_fzf_complete_git() {
    ...
    case "$ARGS" in
        'co '* | 'checkout '* )
            _git_completition_command='checkout'
        ...
        'rabase -i '* | 'rbi '* )
            ...
            _git_completition_command='rebase'
