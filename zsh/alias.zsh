...
alias gd='git diff'
alias gl="git log --color --graph --pretty=format:'%Cred%h%Creset -%C(yellow)%d%Creset %Cgreen(%cr) %C(bold blue)%an <%ce>%Creset%n%B' --date=relative"
alias glg='gl --name-status'
alias gr='git rebase'
