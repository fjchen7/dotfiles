...
local vimer = {
  ...
  p = {function()
    ...
    vim.notify("Complete PackerInstall and PackerCompile")
...
-- cheatsheet only for preview
  name = "cheatsheet",
  b = {"<cmd>h :buffers<cr>", "meaning of buffer symbol"},
  k = {"<cmd>h map-table<cr>", "mapping type"},
  m = {"<cmd>h '[<cr>", "meaning of special mark"},
  t = {"<cmd>!open https://github.com/nvim-telescope/telescope-fzf-native.nvim<cr>", "telescope search syntax", {silent = true}},
  x = {
...
require("which-key").register(cht, {prefix = "<leader>,,"})
