...
local get_keymaps = function()
  ...
  local keymaps = {
    ...
    diff3 = {
      ...
      { { "n", "x" }, "2do", actions.diffget("ours"), { desc = "Obtain diff hunk from OURS version" } },
      { { "n", "x" }, "3do", actions.diffget("theirs"), { desc = "Obtain diff hunk from THEIRS version" } },
      { "n", "?", actions.help({ "view", "diff3" }), { desc = "diffview_ignore" } },
    },
    diff4 = {
      -- Mappings in 4-way diff layouts
      { { "n", "x" }, "1do", actions.diffget("base"), { desc = "Obtain diff hunk from BASE version" } },
      { { "n", "x" }, "2do", actions.diffget("ours"), { desc = "Obtain diff hunk from OURS version" } },
      { { "n", "x" }, "3do", actions.diffget("theirs"), { desc = "Obtain diff hunk from THEIRS version" } },
