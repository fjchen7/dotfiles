-- LuaSnip examples from https://github.com/L3MON4D3/LuaSnip/blob/master/Examples/snippets. Just for learning.
...
ls.add_snippets("text", {
  s({ trig = "choice", docstring = "choiceXX" }, {
    c(1, {
      t("choice 1"),
      t("choice 2"),
      t("choice 3"),
...
ls.add_snippets("text", {
  ...
  s("mat2", {
    i(1, { "sample_text" }),
    t(": "),
    -- NOTE: if i_1 matches [abc][abc][abc]
    m(1, "[abc][abc][abc]"),
  }),
  ...
  -- NOTE: useful when two insert position is same at most time but can be different.
  s("dl1", {
    i(1, "sample_text"),
    t({ ":", "" }),
    dl(2, l._1, 1),
